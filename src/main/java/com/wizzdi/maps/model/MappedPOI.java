...
public class MappedPOI extends SecuredBasic {
  ...
  @OneToMany(targetEntity = LocationHistory.class, mappedBy = "mappedPOI")
  @JsonIgnore
  private List<LocationHistory> mappedPOILocationHistories;
   ...
   * @return MappedPOI
   */
  public <T extends MappedPOI> T setMappedPOILocationHistories(
